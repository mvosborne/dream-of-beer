  ...
  grunt.initConfig({
    ...
    plato: {
      analyze: {
        ...
        files: {
          'report': ['app.js','public/js/controllers/*.js','routes/*.js']
        }
      }
    },
    ...
    docco: {
      debug: {
        src: ['app.js','public/js/controllers/*.js','routes/*.js'],
        options: {
          output: 'docs/'
        }
      }
    ...
    instrument: {
      files: ['app.js','public/js/controllers/*.js','routes/*.js'],
      options: {
        lazy: true,
