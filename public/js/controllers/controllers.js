(function() {
    ...
    .controller('signupCtrl',
      ...
      angular.module('myApp.controllers')
      .controller('breweriesCtrl', ['$scope', '$http', function($scope, $http) {
        var username=getCookie("username");
        if(username === "") {
         $location.path('/')
        }
        ...
        console.log('brewCtrl');

      }]);//end breweriesCtrl


      angular.module('myApp.controllers')
      .controller('foodPairingsCtrl', ['$scope', '$http', function($scope, $http) {
        var username=getCookie("username");
        if(username === "") {
         $location.path('/')
        }
